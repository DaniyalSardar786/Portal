...
class _EditClassScreenState extends State<EditClassScreen> {
  ...
  void _saveSubjects() async {
    ...
    // Remove all existing subjects for the class and section
    await databaseReference.child("Subjects").child(widget.classs).child(widget.section).remove();

    // Save the newly selected subjects
    await databaseReference.child("Subjects").child(widget.classs).child(widget.section).set(selectedSubjects);
  ...
  Future<void> assignClassTeacher() async {
    if (selectedTeacher != null) {
      ...
      await refTeacher.child(teacherId).child('assignedClass').set({
        'class': widget.classs,
