...
class ChangePasswordScreen extends StatefulWidget {
  ...
  ChangePasswordScreen({super.key, required this.studentDataFromHome, required this.classs, required this.section});
  ...
  void changePassword() async {
    ...
    if (oldPasswordController.text.isNotEmpty &&
      ...
      if (confirmNewPasswordController.text == newPasswordController.text) {
        if (widget.studentDataFromHome != null) {
          final ref = FirebaseDatabase.instance.ref("Classroom")
              .child(widget.classs)
              .child(widget.section)
              .child(widget.studentDataFromHome?["roll_no"]);
          ...
          snackBar("Student data not available!");
        }
      } else {
