...
class _AddStudentScreenState extends State<AddStudentScreen> {
  ...
  TextEditingController addmission_controller = TextEditingController();
  ...
  Future<void> addStudent() async {
    ...
    if (roll_no_controller.text.isNotEmpty) {
      final ref = FirebaseDatabase.instance.ref("Students");
      try {
        await ref.child(roll_no_controller.text.toString()).set({
          "password": "welcome123",
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                buildDropdownButtonFormField("Domicile District", ["Balochistan", "KPK", "Sindh", "Punjab"]),
                const SizedBox(height: 20),
