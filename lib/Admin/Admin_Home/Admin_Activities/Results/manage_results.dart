...
import 'package:portal/Admin/Admin_Home/Admin_Activities/Results/results_students.dart';


class ManageResultsScreen extends StatefulWidget {
  const ManageResultsScreen({Key? key}) : super(key: key);
                            ...
                            trailing: InkWell(
                              onTap: () async {
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ResultsStudentsScreen(
                                      classs: className,
                                      section: sectionName,
                                    ),
                                  ),
